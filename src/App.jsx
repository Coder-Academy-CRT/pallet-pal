...
export default function App() {
    ...
    useEffect(async () => {
        ...
        const res_locations = await api.get(`warehouse/${state.warehouse.id}/locations`)
        dispatch({
        ...
        const res_products = await api.get(`warehouse/${state.warehouse.id}/products`)
        dispatch({
            type: "setProductData",
    ...
    } else { // other two modes will only apply directly to Warehouse or Sidebar rendered components
